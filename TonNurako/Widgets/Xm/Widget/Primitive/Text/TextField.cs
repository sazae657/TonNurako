...
namespace TonNurako.Widgets.Xm
{
	...
	public class TextField : Primitive
	{
		...
		public override int Create(IWidget parent)
		{
            ...
            if(null != remainText) {
                NativeMethods.XmTextFieldSetString(this.Handle.Widget, remainText);
                remainText = null;
            }
        ...
        public void ClearSelection() {
            NativeMethods.XmTextFieldClearSelection(this.Handle.Widget,
                            Native.Xt.XtSports.XtLastTimestampProcessed(this.Handle.Display.Handle));
        }
        public void SetSelection(Text.Range range) {
            NativeMethods.XmTextFieldSetSelection(this.Handle.Widget,
                range.Begin, range.End, Native.Xt.XtSports.XtLastTimestampProcessed(this.Handle.Display.Handle));
        }

        public void Copy() {
            NativeMethods.XmTextFieldCopy(this.Handle.Widget,
                            Native.Xt.XtSports.XtLastTimestampProcessed(this.Handle.Display.Handle));
        }

        public void CopyLink() {
            NativeMethods.XmTextFieldCopyLink(this.Handle.Widget,
                            Native.Xt.XtSports.XtLastTimestampProcessed(this.Handle.Display.Handle));
        }

        public void Cut() {
            NativeMethods.XmTextFieldCut(this.Handle.Widget,
                            Native.Xt.XtSports.XtLastTimestampProcessed(this.Handle.Display.Handle));
        }

        public int GetBaseline() {
            return NativeMethods.XmTextFieldGetBaseline(this.Handle.Widget);
        }


        public bool GetEditable() {
            return NativeMethods.XmTextFieldGetEditable(this.Handle.Widget);
        }

        public void SetEditable(bool editable) {
            NativeMethods.XmTextFieldSetEditable(this.Handle.Widget, editable);
        }

        public int GetInsertionPosition() {
            return (int)NativeMethods.XmTextFieldGetInsertionPosition(this.Handle.Widget);
        }
        public int GetLastPosition() {
            return (int)NativeMethods.XmTextFieldGetLastPosition(this.Handle.Widget);
        }

        public int GetMaxLength() {
            return (int)NativeMethods.XmTextFieldGetMaxLength(this.Handle.Widget);
        }

        public string GetSelection() {
            IntPtr p = NativeMethods.XmTextFieldGetSelection(this.Handle.Widget);
            if (IntPtr.Zero == p) {
                return null;
            }
        ...
        public Text.Range GetSelectionPosition() {
            long begin,  end;
            bool r = NativeMethods.XmTextFieldGetSelectionPosition(this.Handle.Widget, out begin, out end);
            if (true != r) {
                return null;
            }
        ...
        public void Insert(string text, int offset) {
            NativeMethods.XmTextFieldInsert(this.Handle.Widget, (long)offset, text);
        }

        public bool Paste() {
            return NativeMethods.XmTextFieldPaste(this.Handle.Widget);
        }
        public bool PasteLink() {
            return NativeMethods.XmTextFieldPasteLink(this.Handle.Widget);
        }

        public bool Remove() {
            return NativeMethods.XmTextFieldRemove(this.Handle.Widget);
        }

        public void Replace(Text.Range range, string replace) {
            NativeMethods.XmTextFieldReplace(this.Handle.Widget, range.Begin, range.End, replace);
        }

        public void SetAddMode(bool mode) {
            NativeMethods.XmTextFieldSetAddMode(this.Handle.Widget, mode);
        }

        public void SetHighlight(Text.Range range, Text.HighlightMode mode) {
            NativeMethods.XmTextFieldSetHighlight(this.Handle.Widget, range.Begin, range.End, mode);
        }

        public void SetInsertionPosition(TextPosition pos) {
            NativeMethods.XmTextFieldSetInsertionPosition(this.Handle.Widget, pos.Position);
        }

        public void SetMaxLength(int max) {
            NativeMethods.XmTextFieldSetMaxLength(this.Handle.Widget, max);
        }

        public void ShowPosition(int pos) {
            NativeMethods.XmTextFieldShowPosition(this.Handle.Widget, pos);
        }
		...
		public virtual string Value
		{
			get
			{
                ...
                IntPtr pStr = NativeMethods.XmTextFieldGetString(this.Handle.Widget);
			...
			set
			{
                ...
                NativeMethods.XmTextFieldSetString( this.Handle.Widget, value );
			}
